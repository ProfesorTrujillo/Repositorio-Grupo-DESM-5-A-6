...
@ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  ...
  ngOnInit(): void {
    ...
    this._muebleService.limpiarCache();
    ...
    forkJoin({
      ...
      next: (data) => {
        ...
        this.mueblesStockBajo = data.muebles.filter(m => m.stockActual <= m.stockMinimo).length;
        this.mueblesRecientes = [...data.muebles].reverse().slice(0,3);
        
        this.listaInactivos = data.inactivos;
        this.listNotis = data.alertas;
